...
export default function ModInstallerContainer() {
  ...
  const fetchMods = useCallback(async () => {
    ...
    try {
      ...
      setCatalogError(httpErrorToHuman(err) || 'Failed to load mods from Modrinth.');
      setMods([]);
      setTotalHits(0);
    } finally {
        ...
        <div className={'flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6'}>
          <div>
            ...
            <p className={'text-sm text-neutral-400 mt-1'}>
              Discover and install Forge, Fabric, NeoForge, and Quilt mods from Modrinth directly into your server.
            </p>
          </div>
          ...
          <>
            ...
            {loadingMods ? (
              <div className={'flex flex-col items-center justify-center py-24 text-neutral-400 gap-3'}>
                ...
                <span className={'text-sm font-medium'}>Searching verified mods on Modrinth...</span>
              </div>
            ) : mods.length === 0 ? (
